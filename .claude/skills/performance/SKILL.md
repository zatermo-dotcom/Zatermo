...
### Technique 1: LazyLock Initialization
...
// Fixed regexes compile on first use and are then reused
```
...
# ✅ Use: LazyLock (zero runtime overhead)
```
...
1. **🔴 LazyLock regex** (5-10ms per pattern if compiled at runtime)
