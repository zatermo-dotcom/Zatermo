...
> Vendored from [diegosouzapw/OmniRoute](https://github.com/diegosouzapw/OmniRoute)
> (`skills/`). The manifests are upstream-generated; re-sync from upstream rather
...
See [`docs/frameworks/AGENT-SKILLS.md`](https://github.com/diegosouzapw/OmniRoute/blob/main/docs/frameworks/AGENT-SKILLS.md)
in the upstream repository for the full framework reference.
...
## Vendored third-party skills (1)

Installed alongside the OmniRoute catalog but not part of it.

| ID         | Name     | Description                                                                                                  |
| ---------- | -------- | ------------------------------------------------------------------------------------------------------------ |
| `ponytail` | Ponytail | Forces the simplest solution that works (YAGNI, stdlib before custom code). MIT, github.com/DietrichGebert/ponytail. |
